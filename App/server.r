...
advice_view_info <- reactive({
  ...
  ASD_entry_check(get_advice_view_info(query$stockkeylabel, query$year),query$stockkeylabel,query$year)
}) 
...
advice_view_info_previous_year <- eventReactive(req(query$stockkeylabel,query$year), {
  ...
  # get_advice_view_info(query$stockkeylabel, query$year-1)
  ASD_entry_check(get_advice_view_info(query$stockkeylabel, query$year-1),query$stockkeylabel,query$year-1)
})
