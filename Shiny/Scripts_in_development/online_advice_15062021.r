...
setwd("D:/Profile/Documents/GitHub/online-advice/Shiny")
...
shinyApp(
    ui = navbarPage(
        ...
        tags$head(tags$style(HTML("#go{background-color:#dd9314}"))),
...
######this works if you selcet from the map   
    ...
    }) # END 1st OBSERVE EVENT


######## this works if you are selection from the box, unsinf dropdown menu
